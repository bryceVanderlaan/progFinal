...
void initializeApplication(void)
{
	...
	// Allocate the mirror matrix of locks
	// gridOfLocks = new mutex *[numRows];
	// for (unsigned int i = 0; i < numRows; i++)
	//{
	//	gridOfLocks[i] = new mutex[numCols];
	//	for (unsigned int j = 0; j < numCols; j++)
	//	{
	//		// whole grid is unlocked by default
	//		gridOfLocks[i][j].unlock();
	//	}
	//}
